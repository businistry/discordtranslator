...
async function translateText(text, targetLang) {
  try {
    ...
    switch(targetLang) {
      case "es":
        systemPrompt = "You are a professional translator. Translate the following text into natural, fluent Spanish, preserving tone and intent. Return ONLY the translated Spanish text, no extra words.";
        break;
      case "en":
        systemPrompt = "You are a professional translator. Translate the following text into natural, fluent English, preserving tone and intent. Return ONLY the translated English text, no extra words.";
        break;
      case "pt":
        systemPrompt = "You are a professional translator. Translate the following text into natural, fluent Portuguese (Brazilian Portuguese), preserving tone and intent. Return ONLY the translated Portuguese text, no extra words.";
        break;
      case "ko":
        systemPrompt = "You are a professional translator. Translate the following text into natural, fluent Korean, preserving tone and intent. Return ONLY the translated Korean text, no extra words.";
        break;
      default:
        systemPrompt = "You are a professional translator. Translate the following text into natural, fluent English, preserving tone and intent. Return ONLY the translated English text, no extra words.";
    }
